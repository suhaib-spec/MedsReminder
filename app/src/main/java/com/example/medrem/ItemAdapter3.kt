...
class ItemAdapter3(val DataSetNames : ArrayList<String>,val DataSetTypes : ArrayList<String>, val DataSetTimes : ArrayList<String>) : RecyclerView.Adapter<ItemAdapter3.ViewHolder>() {
